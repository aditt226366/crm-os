...
export function CompanyCard({
  ...
  return (
    <GlassCard
      className="group cursor-pointer p-5 transition hover:-translate-y-1 hover:border-cyan-300/30 hover:shadow-glow"
      role="button"
      tabIndex={0}
    ...
    >
      ...
      <p className="mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-cyan-100 transition group-hover:gap-2.5">
        Open workspace
