...
// Access-token lifetime. Kept long so users stay signed in across sessions
// (they remain logged in until they explicitly log out or ~30 days pass).
const ACCESS_TOKEN_TTL = "30d";
const ACCESS_COOKIE_MAX_AGE = 60 * 60 * 24 * 30; // 30 days, matches the token
