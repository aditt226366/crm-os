...
const tableRepairStatements = [
  ...
  "humanQueueId" TEXT,
  "aiRepliesStopped" BOOLEAN NOT NULL DEFAULT false,
  "customerReplyCount" INTEGER NOT NULL DEFAULT 0,
  "totalMessageCount" INTEGER NOT NULL DEFAULT 0,
  ...
  `ALTER TABLE public."Conversation" ADD COLUMN IF NOT EXISTS "aiRepliesStopped" BOOLEAN DEFAULT false;`,
  ...
  `UPDATE public."Conversation" SET "aiRepliesStopped" = false WHERE "aiRepliesStopped" IS NULL;`,
